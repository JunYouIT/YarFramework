...
var Layout = function () {
    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (body.hasClass('page-sidebar-fixed')) {
                ...
                if ((height + headerHeight + footerHeight) <= windowHeight) {
                    height = windowHeight - headerHeight - footerHeight;
                }
            }

            content.attr('style', 'min-height:' + height + 'px');
            //sidebar.attr('style', 'height:' + (windowHeight - headerHeight) + 'px!IMPORTANT');
            if (!(Cookies && Cookies.get('sidebar_closed') === '1')) {
                ...
                $('.page-sidebar-menu').css({ overflow: 'visible' });
            }
    ...
    var handleSidebarMenu = function () {
		...
		$('.page-sidebar').on('click', ' li > a.framefy', function (e) {
			e.preventDefault();
            App.scrollTop();
			...
			pageContent.html('<div id="mainContent"><iframe id="ifcontent" name="ifcontent" style="width:100%;height:100%; border:0px" scrolling="no"></iframe></div>');
			Layout.fixContentHeight();
			$("#mainContent").height(pageContent.height());
    ...
    var handleSidebarToggler = function () {
        var body = $('body');
        if (!$('body').hasClass('page-sidebar-closed') && Cookies && Cookies.get('sidebar_closed') === '1' && App.getViewPort().width >= resBreakpointMd) {
