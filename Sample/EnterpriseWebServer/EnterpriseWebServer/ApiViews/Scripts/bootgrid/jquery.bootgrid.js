     ...
     **/
     Grid.defaults = {
         ...
         **/
         labels: {
            all: "All",
            infos: "第 {{ctx.start}} 到 {{ctx.end}} 共 {{ctx.total}} 条数据",
            loading: "加载中...",
            noResults: "没有数据!",
            refresh: "刷新",
            search: "搜索"
         ...
         **/
         templates: {
            ...
            header: "<div id=\"{{ctx.id}}\" class=\"{{css.header}}\"><div class=\"row\"><div class=\"col-sm-12 actionBar\" style=\"text-align:right;display:table;\"><p class=\"{{css.search}}\"></p><p class=\"{{css.actions}}\"></p></div></div></div>",
            ...
            search: "<div class=\"{{css.search}}\" style=\"width:280px;display:table-cell;vertical-align: middle;margin-right:20px;\"><div class=\"input-group\"><span class=\"input-group-addon \"><i class=\"{{css.icon}} {{css.iconSearch}}\"></i></span> <input type=\"text\" class=\"{{css.searchField}}\" placeholder=\"{{lbl.search}}\" /></div></div>",
     ...
     **/
     Grid.prototype.select = function (rowIds) {
        if (this.selection) {
            ...
            selectedRows = [];
            var n = rowIds.length
            while (n > 0 && !(!this.options.multiSelect && selectedRows.length === 1)) {
                //id = rowIds.pop();
                id = rowIds[n - 1];
                n--;
            ...
            if (selectedRows.length > 0) {
                ...
                if (!this.options.multiSelect)
                {
                    // no need to fire "click" event for rows which should be selected
                    this.element.find("tbody > tr " + selectBoxSelector + ":checked").each(function () {
