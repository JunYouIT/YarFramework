 ...
 * ========================================================= */
 ...
 (function($) {
     var Calendar = function (element, options) {
		...
		this.element.addClass('byccalendar');
     ...
     Calendar.prototype = {
         ...
         _initializeOptions: function (opt) {
             ...
             this.options = {
                 ...
                 language: (opt.language != null && dates[opt.language] != null) ? opt.language : 'chs',
         ...
         _renderHeader: function () {
             ...
             header.addClass('byccalendar-header panel panel-default');
                 ...
                 while (currentDate <= lastDate) {
                     ...
                     do {
                         ...
                         if (currentDate < firstDate) {
                             ...
                             cellContent.attr('id', currentDate.getMonth() + '' + currentDate.getDate());
                             cellContent.addClass('day-content');
                             if (currentDate.getDay() == 0 || currentDate.getDay() == 6) {
                                 cellContent.attr('style', 'background-color:#fff2d6;color:red;border-radius:12px;');
                             }
                             else {
                                 cellContent.attr('style', 'background-color:#eff5f7;color:black;border-radius:12px;');
                             }
         ...
         _applyEvents: function () {
             ...
             this.element.find('.byccalendar-header .prev').click(function () {
                 if (!$(this).hasClass('disabled')) {
             ...
             this.element.find('.byccalendar-header .next').click(function () {
                 if (!$(this).hasClass('disabled')) {
                     _this.element.find('.months-container').animate({ 'margin-left': '-100%' }, 100, function () {
                         _this.element.find('.months-container').css('visibility', 'hidden');
                         _this.element.find('.months-container').css('margin-left', '0');
             ...
             var monthContainerClass = 'month-container col-xs-3';
             ...
             setInterval(function () {
                 ...
                 if ($(_this.element).find('.month-container').attr('class') != monthContainerClass) {
                     $(_this.element).find('.month-container').attr('class', monthContainerClass);
                 }
             }, 2500);
         },
         ...
         _openContextMenu: function (elt) {
             var contextMenu = $('.byccalendar-context-menu');
             ...
             if (contextMenu.length > 0) {
                 ...
                 contextMenu.addClass('byccalendar-context-menu');
