...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,20,30,50],loading:false,buttons:null,showPageList:true,showRefresh:true,links:10,layout:["list","sep","first","prev","sep","manual","sep","next","last","sep","refresh"],onSelectPage:function(_d1,_d2){
    ...
    first: {//modify by yl
        iconCls: "pagination-first fa fa-angle-double-left", handler: function () {
...
$(this).pagination("select",1);
    ...
    iconCls: "pagination-prev fa fa-angle-left", handler: function () {
...
$(this).pagination("select",_d9.pageNumber-1);
    ...
    iconCls: "pagination-next fa fa-angle-right", handler: function () {
...
$(this).pagination("select",_da.pageNumber+1);
    ...
    iconCls: "pagination-last  fa fa-angle-double-right", handler: function () {
...
//modify by yl checkbox position
...
cc.push("<span class=\"tree-icon " + (item.iconCls ? 'tree-folder ' + item.iconCls : "") + "\"></span>");
}else{
...
cc.push("<span class=\"tree-icon " + (item.iconCls ? 'tree-folder tree-folder-open ' + item.iconCls : "") + "\"></span>");
}else{
//cc.push("<span class=\"tree-indent\"></span>");
    ...
    cc.push("<span class=\"tree-icon " + (item.iconCls ? 'tree-file ' + item.iconCls : "") + "\"></span>");
}
}
//end by yl
...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,interval:200,missingMessage:"This field is required.",invalidMessage:null,tipPosition:"right",deltaX:0,deltaY:0,novalidate:false,editable:true,disabled:false,readonly:false,validateOnCreate:false,validateOnBlur:true,events:{focus:_4ab,blur:_4af,mouseenter:_4b2,mouseleave:_4b5,click:function(e){
var t=$(e.data.target);
...
$.fn.textbox.defaults=$.extend({},$.fn.validatebox.defaults,{doSize:true,width:"auto",height:34,cls:null,prompt:"",value:"",type:"text",multiline:false,icons:[],iconCls:null,iconAlign:"right",iconWidth:18,buttonText:"",buttonIcon:null,buttonAlign:"right",label:null,labelWidth:"auto",labelPosition:"before",labelAlign:"left",inputEvents:{blur:function(e){
var t=$(e.data.target);
...
opts=$.extend({},$.extend({},$.fn.datagrid.defaults,{queryParams:{},initLoader:true}),$.fn.datagrid.parseOptions(this),_7b6);
...
_970(node.children);
    ...
    cell.find(".tree-icon").prev("span.tree-indent").addClass("tree-join");
...
if(row.state=="closed"){
    cc.push("<span class=\"tree-hit tree-collapsed\"></span>");
    cc.push("<span class=\"tree-icon " + (row.iconCls ? 'tree-folder ' + row.iconCls : "") + "\"></span>");
    //cc.push("<span class=\"tree-icon tree-folder "+(row.iconCls?row.iconCls:"")+"\"></span>");
}else{
if(row.children&&row.children.length){
    cc.push("<span class=\"tree-hit tree-expanded\"></span>");
    cc.push("<span class=\"tree-icon " + (row.iconCls ? 'tree-folder tree-folder-open ' + row.iconCls : "") + "\"></span>");
//cc.push("<span class=\"tree-icon tree-folder tree-folder-open "+(row.iconCls?row.iconCls:"")+"\"></span>");
}else{
    cc.push("<span class=\"tree-indent\"></span>");
    cc.push("<span class=\"tree-icon " + (row.iconCls ? 'tree-file ' + row.iconCls : "") + "\"></span>");
