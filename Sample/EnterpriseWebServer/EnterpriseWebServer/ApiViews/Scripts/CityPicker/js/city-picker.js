...
(function (factory) {
    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:100%;' +
                    ...
                    '<span style="float:right; padding-top:3px; padding-right:3px;"><a href="javascript:void(0);" class="btn btn-sm btn-warning btn-city-picker-reset">重置<a></span>' +
                    '</div>' +
            ...
            $('.btn-city-picker-reset', this.$dropdown).on('click', function () {
        ...
        close: function (blur, ignoreChange) {
